...
public class PDBDataLoader1 //implements Loader
{
/*
   ...
   public Scene load(String fileName,float mySphereRadius,float myCylinderRadius)
   {
      ...
      Enumeration anEnumeration1 = thePDBMolecule.retrieveEnumeration();
      while(anEnumeration1.hasMoreElements())
      {
         PDBMolecule aPDBMolecule1 = (PDBMolecule)anEnumeration1.nextElement();
         Enumeration anEnumeration2 = thePDBMolecule.retrieveEnumeration();
	...
	Appearance a2 = null;
      ...
      Enumeration anEnumeration3 = thePDBMolecule.retrieveEnumeration();

         while(anEnumeration3.hasMoreElements())
         {
            PDBMolecule aPDBMolecule = (PDBMolecule)anEnumeration3.nextElement();
            Enumeration anEnumeration2 = aPDBMolecule.retrieveEnumeration();
