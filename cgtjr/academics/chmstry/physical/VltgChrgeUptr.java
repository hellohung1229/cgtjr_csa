...
//TODO code clean up
public class VltgChrgeUptr// implements BndryNodeAction_I
{
   private PotentialChrge vltgPotentialDiff;
   ...
   public VltgChrgeUptr()
   {
      vltgPotentialDiff = new PotentialChrge();
      vltgPDBMolecule = PDBMoleculeFile.getPDBMolecule();
      minValue = Float.MAX_VALUE;
      maxValue = -1*Float.MAX_VALUE;
   }
   public VltgChrgeUptr(ShapePnt myShapePnt)
   {
      vltgPotentialDiff = new PotentialChrge(myShapePnt);
      vltgPDBMolecule = PDBMoleculeFile.getPDBMolecule();
      minValue = Float.MAX_VALUE;
      maxValue = -1*Float.MAX_VALUE;
   }
