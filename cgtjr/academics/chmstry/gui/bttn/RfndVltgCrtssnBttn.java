 ...
 */
public class RfndVltgCrtssnBttn extends Sphrcl3DBttn
{

   public RfndVltgCrtssnBttn(SceneRoot mySceneRoot)
   {
      super(mySceneRoot);
   }
   public void addActnLstnr()
   {
      DmnsnVar aDmnsnVar = new DmnsnVar(0,0,0,0,0,0,4,4,4,0.25,0.25,0.25);
      VltgGrpRfnPrcss aVltgGrpRfnPrcss = new VltgGrpRfnPrcss(aDmnsnVar,getScnRt());
