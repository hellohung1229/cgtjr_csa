...
public class VltgChrgGrpPrcss extends DataPrcss
{
   SceneRoot scnRt;
   DmnsnVar shpDmnsnVar;
   CrdntShp crdntShp;
   
   public VltgChrgGrpPrcss(DmnsnVar myDmnsnVar,SceneRoot mySceneRoot)
   {
      scnRt = mySceneRoot;
   ...
   /*
   public VltgChrgGrpPrcss(ShapePnt myShape,SceneRoot mySceneRoot)
   {
      scnRt = mySceneRoot;
      crdntShp = myShape;
   }*/
