...
public class VltgChrgGrpRfnPrcss extends DataPrcss
{
   SceneRoot scnRt;
   DmnsnVar shpDmnsnVar;
   ShapePnt crdntShp;
   
   public VltgChrgGrpRfnPrcss(DmnsnVar myDmnsnVar,SceneRoot mySceneRoot)
   {
      scnRt = mySceneRoot;
      shpDmnsnVar = myDmnsnVar;
      //crdntShp = PDBMolecule.rtrvShape(shpDmnsnVar);
   }
   public VltgChrgGrpRfnPrcss(ShapePnt myShape,SceneRoot mySceneRoot)
   {
      scnRt = mySceneRoot;
      crdntShp = myShape;
   }
   ...
   {    
      ...
      VltgChrgePrcss aVltgChrgePrcss = new VltgChrgePrcss(aHxhdrlRfndMsh);
