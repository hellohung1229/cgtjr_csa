...
public class VideoClusterGlblTrackApplt extends JApplet {
    ...
    private ClusterGlblTrackFltr imageFilters;
    ...
    public void start() {
        ...
        imageFilters = new ClusterGlblTrackFltr();
        imageFilters.setThreshold(1);
        imageFilters.setTmprlGrdntThrshld(25);
        imageFilters.setClusterMaxDistance(15);
