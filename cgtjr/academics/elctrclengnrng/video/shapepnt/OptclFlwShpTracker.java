...
import cgtjr.academics.elctrclengnrng.imgprcssng.pntvertex.SSDDrwActn;
...
import cgtjr.academics.elctrclengnrng.imgprcssng.pntvertex.PntOptclFlwFltr;
 ...
 */
public class OptclFlwShpTracker implements ParseAction
{
   ...
   private PntOptclFlwFltr aPntOptclFlwFltr;
   private Image otptImage;
   private int width;
   private int height;
   private Image img;
   
   public OptclFlwShpTracker(ShpBndry myImageBndry)
   {
      shapeBndry = myImageBndry;
      pixelInsrtActn = new GridDrawActn();
      crdntInsrt = new SSDDrwActn();      
      isSttnryWndw = false;
      aPntOptclFlwFltr = new PntOptclFlwFltr();
   }
   /*
   ...
   public Image actn(Image myImage, int myWidth, int myHeight)
   {
      ...
      //aPntOptclFlwFltr.initialize(width, height);
      //System.out.println("ShpTracker: test 104 myPixelData2[1]"+myPixelData2[1]);
      //aPntOptclFlwFltr.setGryVls(gryOtptPxlData);
      //aPntOptclFlwFltr.setGrdntMgntd(otptPixels);
      //System.out.println("ShpTracker: test 106");
      //aPntOptclFlwFltr.filter9x9(inputPixels, aVector);
