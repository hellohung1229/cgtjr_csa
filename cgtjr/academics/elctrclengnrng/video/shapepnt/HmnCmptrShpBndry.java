...
/*
 * This class needs to be removed or updated !!!
 * 
 * 
 */
public class HmnCmptrShpBndry extends TrckrShpBndry
{
   ...
   public HmnCmptrShpBndry()
   {
      //dcsnBndies0 = new TrckrBndry();
      //dcsnBndies1 = new TrckrBndry();
      //dcsnBndies2 = new TrckrBndry();
   }
   public HmnCmptrShpBndry(ShpBndry myShpBndry,GridDrawActn aPntPxlInsrtActn)
   {
