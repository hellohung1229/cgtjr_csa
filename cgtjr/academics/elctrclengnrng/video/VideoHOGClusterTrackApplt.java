...
import cgtjr.academics.elctrclengnrng.imgprcssng.general.ImgFrmeParser;
...
public class VideoHOGClusterTrackApplt extends JApplet {
    ...
    public void start() {
        ...
        imageFilters.getClusterHOGTrackerTmp().setMaxClusterDistance(12);        
        imageFilters.getCornerDetectGrdntTmp().setEigenThreshold(500);
        imageFilters.getTmprlGrdntFilter().setTmprlGrdntThrshld(15);
        imageFilters.getHogCornerDetectorTmp().setMaxMatchDstnce(15);
        //TODO: consider creating a setParameter function, example setParameter("displaycorners",true);
        /* 
        imageFilters.setDisplayCorners(false);
