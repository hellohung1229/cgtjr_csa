...
public class SSDRGBCornerFltr extends CornerDetect {
    ...
    public int cmptSSD(int myIndex1,int myIndex2) {        
        ...
        if (isInBounds3x3(myIndex1) && isInBounds3x3(myIndex2)) {
            ...
            int tmprlGrdntRed1 = ColorSpectra.rtrvRed(crrntImgData[myIndex1 - imgWidth - 1]) - ColorSpectra.rtrvRed(prevImgData[myIndex2 - imgWidth - 1]);
            int tmprlGrdntRed2 = ColorSpectra.rtrvRed(crrntImgData[myIndex1 - imgWidth]) - ColorSpectra.rtrvRed(prevImgData[myIndex2 - imgWidth]);
            int tmprlGrdntRed3 = ColorSpectra.rtrvRed(crrntImgData[myIndex1 - imgWidth + 1]) - ColorSpectra.rtrvRed(prevImgData[myIndex2 - imgWidth + 1]);
            int tmprlGrdntRed4 = ColorSpectra.rtrvRed(crrntImgData[myIndex1 - 1]) - ColorSpectra.rtrvRed(prevImgData[myIndex2 - 1]);
            int tmprlGrdntRed5 = ColorSpectra.rtrvRed(crrntImgData[myIndex1]) - ColorSpectra.rtrvRed(prevImgData[myIndex2]);
            int tmprlGrdntRed6 = ColorSpectra.rtrvRed(crrntImgData[myIndex1 + 1]) - ColorSpectra.rtrvRed(prevImgData[myIndex2 + 1]);
            int tmprlGrdntRed7 = ColorSpectra.rtrvRed(crrntImgData[myIndex1 + imgWidth - 1]) - ColorSpectra.rtrvRed(prevImgData[myIndex2 + imgWidth - 1]);
            int tmprlGrdntRed8 = ColorSpectra.rtrvRed(crrntImgData[myIndex1 + imgWidth]) - ColorSpectra.rtrvRed(prevImgData[myIndex2 + imgWidth]);
            int tmprlGrdntRed9 = ColorSpectra.rtrvRed(crrntImgData[myIndex1 + imgWidth + 1]) - ColorSpectra.rtrvRed(prevImgData[myIndex2 + imgWidth + 1]);

            int tmprlGrdntGreen1 = ColorSpectra.rtrvGreen(crrntImgData[myIndex1 - imgWidth - 1]) - ColorSpectra.rtrvGreen(prevImgData[myIndex2 - imgWidth - 1]);
            int tmprlGrdntGreen2 = ColorSpectra.rtrvGreen(crrntImgData[myIndex1 - imgWidth]) - ColorSpectra.rtrvGreen(prevImgData[myIndex2 - imgWidth]);
            int tmprlGrdntGreen3 = ColorSpectra.rtrvGreen(crrntImgData[myIndex1 - imgWidth + 1]) - ColorSpectra.rtrvGreen(prevImgData[myIndex2 - imgWidth + 1]);
            int tmprlGrdntGreen4 = ColorSpectra.rtrvGreen(crrntImgData[myIndex1 - 1]) - ColorSpectra.rtrvGreen(prevImgData[myIndex2 - 1]);
            int tmprlGrdntGreen5 = ColorSpectra.rtrvGreen(crrntImgData[myIndex1]) - ColorSpectra.rtrvGreen(prevImgData[myIndex2]);
            int tmprlGrdntGreen6 = ColorSpectra.rtrvGreen(crrntImgData[myIndex1 + 1]) - ColorSpectra.rtrvGreen(prevImgData[myIndex2 + 1]);
            int tmprlGrdntGreen7 = ColorSpectra.rtrvGreen(crrntImgData[myIndex1 + imgWidth - 1]) - ColorSpectra.rtrvGreen(prevImgData[myIndex2 + imgWidth - 1]);
            int tmprlGrdntGreen8 = ColorSpectra.rtrvGreen(crrntImgData[myIndex1 + imgWidth]) - ColorSpectra.rtrvGreen(prevImgData[myIndex2 + imgWidth]);
            int tmprlGrdntGreen9 = ColorSpectra.rtrvGreen(crrntImgData[myIndex1 + imgWidth + 1]) - ColorSpectra.rtrvGreen(prevImgData[myIndex2 + imgWidth + 1]);

            int tmprlGrdntBlue1 = ColorSpectra.rtrvBlue(crrntImgData[myIndex1 - imgWidth - 1]) - ColorSpectra.rtrvBlue(prevImgData[myIndex2 - imgWidth - 1]);
            int tmprlGrdntBlue2 = ColorSpectra.rtrvBlue(crrntImgData[myIndex1 - imgWidth]) - ColorSpectra.rtrvBlue(prevImgData[myIndex2 - imgWidth]);
            int tmprlGrdntBlue3 = ColorSpectra.rtrvBlue(crrntImgData[myIndex1 - imgWidth + 1]) - ColorSpectra.rtrvBlue(prevImgData[myIndex2 - imgWidth + 1]);
            int tmprlGrdntBlue4 = ColorSpectra.rtrvBlue(crrntImgData[myIndex1 - 1]) - ColorSpectra.rtrvBlue(prevImgData[myIndex2 - 1]);
            int tmprlGrdntBlue5 = ColorSpectra.rtrvBlue(crrntImgData[myIndex1]) - ColorSpectra.rtrvBlue(prevImgData[myIndex2]);
            int tmprlGrdntBlue6 = ColorSpectra.rtrvBlue(crrntImgData[myIndex1 + 1]) - ColorSpectra.rtrvBlue(prevImgData[myIndex2 + 1]);
            int tmprlGrdntBlue7 = ColorSpectra.rtrvBlue(crrntImgData[myIndex1 + imgWidth - 1]) - ColorSpectra.rtrvBlue(prevImgData[myIndex2 + imgWidth - 1]);
            int tmprlGrdntBlue8 = ColorSpectra.rtrvBlue(crrntImgData[myIndex1 + imgWidth]) - ColorSpectra.rtrvBlue(prevImgData[myIndex2 + imgWidth]);
            int tmprlGrdntBlue9 = ColorSpectra.rtrvBlue(crrntImgData[myIndex1 + imgWidth + 1]) - ColorSpectra.rtrvBlue(prevImgData[myIndex2 + imgWidth + 1]);
            
            ssd = tmprlGrdntRed1*tmprlGrdntRed1 + tmprlGrdntRed2*tmprlGrdntRed2 +
                  tmprlGrdntRed3*tmprlGrdntRed3 + tmprlGrdntRed4*tmprlGrdntRed4 +
                  tmprlGrdntRed5*tmprlGrdntRed5 + tmprlGrdntRed6*tmprlGrdntRed6 +
                  tmprlGrdntRed7*tmprlGrdntRed7 + tmprlGrdntRed8*tmprlGrdntRed8 +
                  tmprlGrdntRed9*tmprlGrdntRed9+
                  
                  tmprlGrdntGreen1*tmprlGrdntGreen1 + tmprlGrdntGreen2*tmprlGrdntGreen2 +
                  tmprlGrdntGreen3*tmprlGrdntGreen3 + tmprlGrdntGreen4*tmprlGrdntGreen4 +
                  tmprlGrdntGreen5*tmprlGrdntGreen5 + tmprlGrdntGreen6*tmprlGrdntGreen6 +
                  tmprlGrdntGreen7*tmprlGrdntGreen7 + tmprlGrdntGreen8*tmprlGrdntGreen8 +
                  tmprlGrdntGreen9*tmprlGrdntGreen9+
                    
                  tmprlGrdntBlue1*tmprlGrdntBlue1 + tmprlGrdntBlue2*tmprlGrdntBlue2 +
                  tmprlGrdntBlue3*tmprlGrdntBlue3 + tmprlGrdntBlue4*tmprlGrdntBlue4 +
                  tmprlGrdntBlue5*tmprlGrdntBlue5 + tmprlGrdntBlue6*tmprlGrdntBlue6 +
                  tmprlGrdntBlue7*tmprlGrdntBlue7 + tmprlGrdntBlue8*tmprlGrdntBlue8 +
                  tmprlGrdntBlue9*tmprlGrdntBlue9;                    
    ...
    public void finish() {
        System.out.println("SSDRGBCornerFltr: finish parsing frame = " + frameIndex);
