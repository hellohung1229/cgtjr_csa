...
package cgtjr.academics.elctrclengnrng.video.capture;
...
public class JVidCap extends Frame implements ItemListener, ActionListener {
	...
	comboEncoding.add("dvsd"); // Add YUV, etc.
   ...
   comboSize.add("720x480");
   comboSize.add("160x120");
	comboSize.add("320x240");
	comboSize.add("640x480");
// Add more sizes if your card supports
