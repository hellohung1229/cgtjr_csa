 ...
 */
public class VdCntrllrLstnrTrckr extends JApplet implements ControllerListener {
    ...
    public Panel beganApplication() {
        ...
        try {
            ...
            VideoCompRndrr anotherVideoCompRndrr = new VideoCompRndrr();

            setRenderer(theTrackControl, anotherVideoCompRndrr);
    ...
    public void setRenderer(TrackControl[] myTrackControl,
            VideoCompRndrr myVideoCompRndrr) {
        ...
        try {
            for (int i = 0; i < aSize; i++) {
                ...
                if (aFormat.toString().startsWith("H263")) {
                    myTrackControl[i].setRenderer(myVideoCompRndrr);
