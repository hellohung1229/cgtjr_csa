 ...
 */
public class VideoCompRndrr implements javax.media.renderer.VideoRenderer {
    ...
    private CornerDtct videoOpticalFlowFltr;
    //private CornerDtct_2 videoOpticalFlowFltr;
    ...
    public VideoCompRndrr() {
        ...
        videoOpticalFlowFltr = new CornerDtct();
        //videoOpticalFlowFltr = new CornerDtct_2();
    ...
    private void newImage(Buffer buffer) {
        ...
        if (component != null) {
            ...
            //renderedImage = videoOpticalFlowFltr.CornerDtct(destImage,40000,3);
