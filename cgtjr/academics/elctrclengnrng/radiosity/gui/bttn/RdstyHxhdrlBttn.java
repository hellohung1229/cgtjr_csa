 ...
 */
public class RdstyHxhdrlBttn extends Crtssn3DBttn
{

   public RdstyHxhdrlBttn(SceneRoot mySceneRoot)
   {
      super(mySceneRoot);
   }
   public RdstyHxhdrlBttn(SceneRoot mySceneRoot,Applet myLabWndwPnl)
   {
