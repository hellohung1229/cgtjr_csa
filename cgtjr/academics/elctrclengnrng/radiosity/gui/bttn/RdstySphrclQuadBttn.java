 ...
 */
public class RdstySphrclQuadBttn extends SphrclSrfcBttn
{

   public RdstySphrclQuadBttn(SceneRoot mySceneRoot)
   {
      super(mySceneRoot);
   }
   public RdstySphrclQuadBttn(SceneRoot mySceneRoot,Applet myLabWndwPnl)
   {
