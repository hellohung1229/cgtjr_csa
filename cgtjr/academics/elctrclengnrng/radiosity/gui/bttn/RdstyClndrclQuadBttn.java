 ...
 */
public class RdstyClndrclQuadBttn extends ClndrclSrfcBttn
{

   public RdstyClndrclQuadBttn(SceneRoot mySceneRoot)
   {
      super(mySceneRoot);
   }
   public RdstyClndrclQuadBttn(SceneRoot mySceneRoot,Applet myLabWndwPnl)
   {
