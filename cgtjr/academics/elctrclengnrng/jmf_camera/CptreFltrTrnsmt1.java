...
public class CptreFltrTrnsmt1 {
   ...
   public CptreFltrTrnsmt1(MediaLocator locator,
           String ipAddress,
           String port) {
         ...
         for (int y = 0; y < deviceFormat.length; y++) {
            ...
            if (captureVideoDevice == null) {
               if (deviceFormat[y] instanceof VideoFormat) {
                  System.out.println("CptreFltrTrnsmt: test 3");
   ...
   private Component rtrvVslCmpnt()
   {
   ...
   private String createProcessor2() {
      ...
      System.out.println("CptreFltrTrnsmt: test 1");
      DataSource ds = null;
      DataSource clone;
      System.out.println("CptreFltrTrnsmt : " + locator);
      try {
   ...
   public static void main(String[] args) {
      ...
      //        args[2]);
      // Start the transmission
      CptreFltrTrnsmt1 vt = new CptreFltrTrnsmt1();
