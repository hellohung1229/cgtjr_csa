...
public class ImgParser implements FrameParser//extends Filter //implements ImageObserver
{
    ...
    public ImgParser(Image myInputImage, ImageFilter myImageFilter) {
        prsdImageFilter = myImageFilter;
        inputImage = myInputImage;
    }

    public ImgParser(String fileName, ImageFilter myImageFilter) {
        prsdImageFilter = myImageFilter;
        inputImage = UgotImage.createImage(fileName);
    }

    public ImgParser(ImageFilter myImageFilter) {
        prsdImageFilter = myImageFilter;
