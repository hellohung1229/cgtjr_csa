...
public class ImgFrmeParser implements FrameParser//extends Filter //implements ImageObserver
{
    ...
    public ImgFrmeParser(Image myInputImage, ImageFilter myImageFilter) {
        prsdImageFilter = myImageFilter;
        inputImage = myInputImage;
    }

    public ImgFrmeParser(String fileName, ImageFilter myImageFilter) {
        prsdImageFilter = myImageFilter;
        inputImage = UgotImage.createImage(fileName);
    }

    public ImgFrmeParser(ImageFilter myImageFilter) {
        prsdImageFilter = myImageFilter;
