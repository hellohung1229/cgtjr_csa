 ...
 */
public class CrrltnImage extends ImageBndry
{
   private SumSqrDiff ssd[];
   private int index = 1;
   
   public CrrltnImage(String myFileName1,String myFileName2)
   {
      super(new DmnsnVar());
      ssd = new SumSqrDiff[10];
      ssd[0] = new SumSqrDiff(myFileName1,myFileName2);
   }
   public CrrltnImage(String myFileName1)
   {
      super(new DmnsnVar());
      ssd = new SumSqrDiff[10];
   ...
   public CrrltnImage(FileNameVar myDmnsnVar)
   {
      super(myDmnsnVar);
      ssd = new SumSqrDiff[10];
   ...
   public CrrltnImage(FileNameVar myFileNameVar1,FileNameVar myFileNameVar2)
   {
      super(new DmnsnVar());
