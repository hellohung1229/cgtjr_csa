...
import cgtjr.academics.elctrclengnrng.electromagnetic.EField;
 ...
 */
public class EFieldActn extends GridDrawActn {
    ...
    public EFieldActn(int myImgPixels[], int myImgWdth, int myImgHght) {
    ...
    public void nodeCreateAction(Pnt aPoint, Pnt myPoint4, Pnt myPoint6, Pnt myPoint7, int myDepthCounter, int myDepth, int myTotalNumber) {
        ...
        /*
         * int x = (int)myPoint7.getX1(); int y = (int)myPoint7.getY1();          *
         * int x1 = Round.getDgtPxlPstn(1,2); int x2 = Round.getDgtPxlPstn(2,2);          *
         * if(x%40!=0 || y%40!=0 || x+x1 < 0 || x+x1 > imgDtWdth || x+x2 < 0 ||
         * x + x2 > imgDtWdth) { return; } int glblIndx = myPoint7.getCounter();
         * int aLength = Round.getDgtLngth(glblIndx);          *
         * //System.out.println("NumberDrawActn: image width = "+imgDtWdth+", x
         * = "+x+", x1 = "+x1+", x2 = "+x2); int aDigit3 =
         * Round.getDigit(glblIndx,2);
         *
         * int aDigit4 = Round.getDigit(glblIndx,1);
         *
         *
         * int pxlData3[] = DigitPixels.rtrvNmbr(aDigit3); int pxlData4[] =
         * DigitPixels.rtrvNmbr(aDigit4); //System.out.println("NumberDrawActn:
         * aDigit0 = "+aDigit0+", aDigit1 = "+aDigit1);
         * //System.out.println("NumberDrawActn: global index = "+glblIndx+",
         * digit length = "+aLength);
         *
         * int myIndex1 = ImageTool.rtrvIndex(x+x1, y, imgDtWdth); int myIndex2
         * = ImageTool.rtrvIndex(x+x2, y, imgDtWdth);          *
         ...
         * //System.out.println("NumberDrawActn: index1 = "+myIndex+", nmbrIndex
         * = "+nmbrIndex);
         *
         */
        float aZValue = myPoint7.getY1();
        ...
        System.out.println("EFieldInsrtActn: aZValue = "+aZValue+", E Mag = " + aMag / mgntde);
    }
    ...
    public void nodeInitAction(Pnt aPoint, Pnt myPoint7, int myDepthCounter, int myDepth, int myTotalNumber) {
        ...
        /*
         * int x = (int)myPoint7.getX1(); int y = (int)myPoint7.getY1(); int
         * glblIndx = myPoint7.getCounter(); int pxlData[] =
         * DigitPixels.rtrvNmbr(glblIndx); int myIndex = ImageTool.rtrvIndex(x,
         * y, imgDtWdth); // //System.out.println("NumberDrawactn: imgDtWdth =
         * "+imgDtWdth+", imgDtHght = "+imgDtHght);
    ...
    public void nodeOriginAction(Pnt aPoint, int myDepthCounter, int myDepth, int myTotalNumber) {
        ...
        /*
         * int x = (int)aPoint.getX1(); int y = (int)aPoint.getY1(); int
         * glblIndx = aPoint.getCounter(); int pxlData[] =
         * DigitPixels.rtrvNmbr(glblIndx); int myIndex = ImageTool.rtrvIndex(x,
         * y, imgDtWdth); //System.out.println("NumberDrawactn: imgDtWdth =
         * "+imgDtWdth+", imgDtHght = "+imgDtHght);
         * DigitPixels.draw9x9(imgPixels,pxlData,imgDtWdth,imgDtHght,myIndex,nmbrIndex);
