 ...
 */
public class RectBndryHOGArrayList extends ArrayList {
    ...
    public RectBndryHOGArrayList(HOGPosition myHOGPosition) {
        super();
        mathVectorMap = new HashMap();
    ...
    public void insertTrackID(HOGPosition myHOGPosition) {
        ...
        if (aHOGPosition != null) {
            RectBndryHOGArrayList trackerBoundary = (RectBndryHOGArrayList) aHOGPosition.getTrackBoundary();
            ...
            if(mathVectorMap == null) System.out.println("RectBndryHOGArrayList : trackerBoundary = null");
    ...
    public void updateTrackInfo() {
        ...
        while (anIterator2.hasNext()) {
            ...
            if (aHOGMatch != null) {
                RectBndryHOGArrayList aRectBndryHOGArrayList = (RectBndryHOGArrayList) aHOGMatch.getTrackBoundary();
