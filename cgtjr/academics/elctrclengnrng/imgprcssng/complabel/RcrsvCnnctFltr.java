 ...
 */
public class RcrsvCnnctFltr extends ImageFilter {
    ...
    public void initialize(int myImageWidth, int myImageHeight) {
        ...
        outputValues = new int[width * height]; 
    }

    public void filter(int myOriginalValues[], int i) {
        
        outputValues = myOriginalValues;        
        if (inputValues != null) {
    ...
    public void drawSquare() {
        if (boxReady) {
            ...
            LineDraw.drawLine(groupXMin, groupYMin, groupXMax, groupYMin, outputValues, width, height,cmpnntColor);
            LineDraw.drawLine(groupXMin,groupYMin,groupXMin,groupYMax, outputValues, width, height,cmpnntColor);        
            LineDraw.drawLine(groupXMax,groupYMin,groupXMax,groupYMax, outputValues, width, height,cmpnntColor);        
            LineDraw.drawLine(groupXMin,groupYMax,groupXMax,groupYMax, outputValues, width, height,cmpnntColor);        
            float x = (groupXMax - groupXMin)/2.0f + groupXMin;
            float y = (groupYMax - groupYMin)/2.0f + groupYMin;
            nmbrDtctd++;
