...
public class GrdntFilterParser extends TmprlGrdntFltr {
    ...
    public GrdntFilterParser() {
        super();
    }

    public GrdntFilterParser(String myFileName) {
    }
    ...
    public void grdntFilter(int myIntlValues[], int i, int imageWidth, int imageHeight) {
          ...
          try {           
            ...
            grdntHrzntl[i] =
            //int grdntHrzntl = 
                    (getGryVls(i - imageWidth - 1) * krnlHrzntl[0][0]
                    + getGryVls(i - imageWidth) * krnlHrzntl[0][1]
                    + getGryVls(i - imageWidth + 1) * krnlHrzntl[0][2]
                    + getGryVls(i - 1) * krnlHrzntl[1][0]
                    + getGryVls(i) * krnlHrzntl[1][1]
                    + getGryVls(i + 1) * krnlHrzntl[1][2]
                    + getGryVls(i + imageWidth - 1) * krnlHrzntl[2][0]
                    + getGryVls(i + imageWidth) * krnlHrzntl[2][1]
                    + getGryVls(i + imageWidth + 1) * krnlHrzntl[2][2]);

            grdntVrtcl[i] =
            //int grdntVrtcl =
                    (getGryVls(i - imageWidth - 1) * krnlVrtcl[0][0]
                    + getGryVls(i - imageWidth) * krnlVrtcl[0][1]
                    + getGryVls(i - imageWidth + 1) * krnlVrtcl[0][2]
                    + getGryVls(i - 1) * krnlVrtcl[1][0]
                    + getGryVls(i) * krnlVrtcl[1][1]
                    + getGryVls(i + 1) * krnlVrtcl[1][2]
                    + getGryVls(i + imageWidth - 1) * krnlVrtcl[2][0]
                    + getGryVls(i + imageWidth) * krnlVrtcl[2][1]
                    + getGryVls(i + imageWidth + 1) * krnlVrtcl[2][2]);
            ...
            if(grdntMgntd[i] > 10){
               //getImageDrawData().updatePixels(grdntMgntd, i);
            }
        } catch (ArrayIndexOutOfBoundsException aiob) {
        }
    ...
    public int grdntGryFilter(int myIntlValues[], int i) {
        return gryFltr1x1(myIntlValues, i);
    }
