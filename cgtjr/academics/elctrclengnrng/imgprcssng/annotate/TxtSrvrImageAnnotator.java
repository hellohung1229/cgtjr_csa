...
import cgtjr.academics.elctrclengnrng.networking.FeatureLogClient;
 ...
 * @author finitesystem
 */
public class TxtSrvrImageAnnotator implements Runnable {

    private AnnotateFeatureVar theAnnotationBoxVar;
    private int frameNumber;
    private int frameDelay = 90;

    public TxtSrvrImageAnnotator() {
    ...
    public void process(String myDate, int myFrameNumber, int myWidth, int myHeight, int myIDNmbr, int myXMin, int myYMin, int myXMax, int myYMax, String myDescription) {    
        System.out.println("TxtSrvrImageAnnotator ... test 8");
   ...
   public void process(AnnotateFeatureVar myAnnotationBoxVar) {    
        ...
        theAnnotationBoxVar.setChrctrstcScaleValue(myAnnotationBoxVar.getChrctrstcScaleValue());     
        theAnnotationBoxVar.setTrnsltnMgntdeValue(myAnnotationBoxVar.getTrnsltnMgntdeValue());                
        theAnnotationBoxVar.setTrnsltnPhaseValue(myAnnotationBoxVar.getTrnsltnPhaseValue()); 
        theAnnotationBoxVar.setRotationAngleValue(myAnnotationBoxVar.getRotationAngleValue());         
    ...
    public void startAnnotation() {
        ...
        //System.out.println("TxtSrv rImageAnnotator : aFrameDelayNmbr = "+aFrameDelayNmbr);
        if (frameNumber == 2 || aFrameDelayNmbr == 0) {
    ...
    public void run() {
        ...
        String output = ""
                ...
                + theAnnotationBoxVar.getChrctrstcScaleValue() + ", "   
                + theAnnotationBoxVar.getTrnsltnMgntdeValue()+ ", "   
                + theAnnotationBoxVar.getTrnsltnPhaseValue()+ ", "                  
                + theAnnotationBoxVar.getRotationAngleValue()+ ", "                  
                + theAnnotationBoxVar.getDescriptionValue();
        System.out.println(output);
        //HTTPTransmit aHTTPTransmit = new HTTPTransmit();
        FeatureLogClient aFeatureLogClient = new FeatureLogClient();
        ...
        aFeatureLogClient.post("localhost", aHashMap);
