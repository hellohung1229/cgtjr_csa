...
public class GrdntGryFilter extends TmprlGrdntFltr {
    /*
    ...
    public GrdntGryFilter() {
        super();
    }

    public GrdntGryFilter(String myFileName) {
    }
    ...
    public void filter(int myIntlValues[], int i) {
        ...
        grdntGryFilter(myIntlValues, i, imageWidth, imageHeight);
        //grdntFilter3x3(myIntlValues, i);        
    }
