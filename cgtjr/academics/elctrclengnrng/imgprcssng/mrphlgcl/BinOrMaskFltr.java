...
public class BinOrMaskFltr extends ImageFilter
{
   ...
   public BinOrMaskFltr(){}
   public BinOrMaskFltr(String myFileName)
   {
      super(myFileName);
   ...
   public BinOrMaskFltr(int myPixelData[],int myImageWidth,int myImageHeight)
   {
