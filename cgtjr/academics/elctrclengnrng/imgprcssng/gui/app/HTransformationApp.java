...
import cgtjr.academics.elctrclengnrng.cv.DLTHOGManual;
 ...
 * @author Nit
 */
public class HTransformationApp extends JApplet
{
    ...
    public HTransformationApp()
    {
      ...
      DLTHOGManual aDLTHOGManual = new DLTHOGManual();          
      anImgRndrr = new ImageRndrr(aDLTHOGManual); 
   ...
   public static void main( String args[] ) 
   {
      ...
      HTransformationApp anImgFrmApp = new HTransformationApp();
