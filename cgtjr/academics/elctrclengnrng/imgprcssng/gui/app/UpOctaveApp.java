...
import cgtjr.academics.elctrclengnrng.imgprcssng.UpSample;
 ...
 * @author Nit
 */
public class UpOctaveApp extends JApplet {
    ...
    public UpOctaveApp() {
        ...
        UpSample aUpSample = new UpSample();
        anImgRndrr = new ImageRndrr(aUpSample);
    ...
    public static void main(String args[]) {
        ...
        UpOctaveApp anImgFrmApp = new UpOctaveApp();
