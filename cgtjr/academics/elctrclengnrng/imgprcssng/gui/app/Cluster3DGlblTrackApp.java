...
import cgtjr.academics.elctrclengnrng.cv.clustering.ClusterGlblTrackFltr;
 ...
 * @author Nit
 */
public class Cluster3DGlblTrackApp extends JApplet
{
    ...
    public Cluster3DGlblTrackApp()
    {
      ...
      ClusterGlblTrackFltr aCluster3DTrackFltr = new ClusterGlblTrackFltr();   
      ...
      aCluster3DTrackFltr.setThreshold(100);
      aCluster3DTrackFltr.setTmprlGrdntThrshld(25);
      //aCluster3DTrackFltr.setClusterMaxDistance(25);
      //aCluster3DTrackFltr.setMatchDstnceThrshld(40);      
   ...
   public static void main( String args[] ) 
   {
      ...
      Cluster3DGlblTrackApp anImgFrmApp = new Cluster3DGlblTrackApp();
