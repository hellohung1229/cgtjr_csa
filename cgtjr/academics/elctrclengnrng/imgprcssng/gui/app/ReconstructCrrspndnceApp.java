...
import cgtjr.academics.elctrclengnrng.cv.FndmntlMatrixDLTHOGMnl;
 ...
 * @author 
 */
public class ReconstructCrrspndnceApp extends JApplet
{
    ...
    public ReconstructCrrspndnceApp()
    {
      anImgArryLst = new ArrayList();  
      anImgPlyrCnvs = new ImgPlyrCnvs(anImgArryLst);
      FndmntlMatrixDLTHOGMnl aFndmntlMatrixDLTHOGMnl = new FndmntlMatrixDLTHOGMnl(); 
      //ClusterHOGTracker aFndmntlMatrixDLTHOGMnl = new ClusterHOGTracker();

      //FndmntlMatrixDLTHOGMnl.setMatchDstnceThrshld(100);    

      //aFndmntlMatrixDLTHOGMnl.setEigenThreshold(4000);
      aFndmntlMatrixDLTHOGMnl.setTmprlGrdntThrshld(15);        
      //aFndmntlMatrixDLTHOGMnl.setHogDstnceThrshld(30.0);        
      aFndmntlMatrixDLTHOGMnl.setDisplayArrows(true);
      aFndmntlMatrixDLTHOGMnl.setDisplayCorners(true);
   
      //aFndmntlMatrixDLTHOGMnl.setMaxClusterDistance(10);
        
      anImgRndrr = new ImageRndrr(aFndmntlMatrixDLTHOGMnl); 
   ...
   public static void main( String args[] ) 
   {
      ...
      ReconstructCrrspndnceApp anImgFrmApp = new ReconstructCrrspndnceApp();
