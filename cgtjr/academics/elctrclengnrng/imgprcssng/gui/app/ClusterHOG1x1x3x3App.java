...
public class ClusterHOG1x1x3x3App extends JApplet
{
    ...
    public ClusterHOG1x1x3x3App()
    {
      ...
      aClusterMapHOGFltr.setThreshold(100);
      aClusterMapHOGFltr.setClusterMaxDistance(6);      
      aClusterMapHOGFltr.setMatchDstnceThrshld(40);   
   ...
   public static void main( String args[] ) 
   {
      ...
      ClusterHOG1x1x3x3App anImgFrmApp = new ClusterHOG1x1x3x3App();
    ...
    public void retrieveMedia() {
        ...
        try {
            ...
            Logger.getLogger(ClusterHOG1x1x3x3App.class.getName()).log(Level.SEVERE, null, ex);
        } catch (IOException ex) {
            Logger.getLogger(ClusterHOG1x1x3x3App.class.getName()).log(Level.SEVERE, null, ex);
        }
