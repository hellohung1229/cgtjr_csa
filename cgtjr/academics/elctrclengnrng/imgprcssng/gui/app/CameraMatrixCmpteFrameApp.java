...
import cgtjr.academics.elctrclengnrng.cv.CameraMatrixDLTHOG;
 ...
 * @author Nit
 */
public class CameraMatrixCmpteFrameApp extends JApplet
{
    ...
    public CameraMatrixCmpteFrameApp()
    {
      ...
      CameraMatrixDLTHOG aCameraMatrixDLTHOG = new CameraMatrixDLTHOG();  
      aCameraMatrixDLTHOG.setMatchDstnceThrshld(40);
      aCameraMatrixDLTHOG.setDisplayArrows(true); 
      aCameraMatrixDLTHOG.setThreshold(17000);  
     
      anImgRndrr = new ImageRndrr(aCameraMatrixDLTHOG); 
   ...
   public static void main( String args[] ) 
   {
      ...
      CameraMatrixCmpteFrameApp anImgFrmApp = new CameraMatrixCmpteFrameApp();
