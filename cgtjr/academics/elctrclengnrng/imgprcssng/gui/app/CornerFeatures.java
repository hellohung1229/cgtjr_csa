...
public class CornerFeatures extends JApplet {
    ...
    public static void main(String args[]) {
        ...
        CornerFeatures anImgFrmApp = new CornerFeatures();
    ...
    public void startApp1() {
        ...
        try {
            ...
            Logger.getLogger(CornerFeatures.class.getName()).log(Level.SEVERE, null, ex);
