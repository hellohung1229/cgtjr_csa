...
import cgtjr.academics.elctrclengnrng.cv.SceneLengthHOG;
 ...
 * @author Nit
 */
public class SceneLengthFrameApp extends JApplet
{
    ...
    public SceneLengthFrameApp()
    {
      ...
      SceneLengthHOG aSceneLengthHOG = new SceneLengthHOG();          
      anImgRndrr = new ImageRndrr(aSceneLengthHOG); 
   ...
   public static void main( String args[] ) 
   {
      ...
      SceneLengthFrameApp anImgFrmApp = new SceneLengthFrameApp();
