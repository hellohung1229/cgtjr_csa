...
import cgtjr.academics.elctrclengnrng.cv.HOGFilter;
 ...
 * @author Nit
 */
public class HogApp extends JApplet
{
    ...
    public HogApp()
    {
      ...
      HOGFilter aHOGFilter = new HOGFilter();           
      anImgRndrr = new ImageRndrr(aHOGFilter); 
