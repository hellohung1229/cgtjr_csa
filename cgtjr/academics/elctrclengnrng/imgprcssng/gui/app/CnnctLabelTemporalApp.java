...
import cgtjr.academics.elctrclengnrng.imgprcssng.complabel.CnnctCmpnntTmprl;
...
public class CnnctLabelTemporalApp extends JApplet {
    ...
    public CnnctLabelTemporalApp() {
        ...
        anImgRndrr = new ImageRndrr(aCnnctCmpnntTmprl);
    ...
    public static void main(String args[]) {
        ...
        CnnctLabelTemporalApp anImgFrmApp = new CnnctLabelTemporalApp();
    ...
    public void startApp1() {
        ...
        try {
            ...
            Logger.getLogger(CnnctLabelTemporalApp.class.getName()).log(Level.SEVERE, null, ex);
        ...
        BufferedImage offScreenImage = new BufferedImage(aWidth, aHeight, BufferedImage.TYPE_INT_ARGB);
