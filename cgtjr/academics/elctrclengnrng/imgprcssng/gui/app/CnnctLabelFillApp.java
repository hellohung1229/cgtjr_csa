...
import cgtjr.academics.elctrclengnrng.imgprcssng.complabel.CnnctCmpntFillFltr;
...
public class CnnctLabelFillApp extends JApplet {
    ...
    public CnnctLabelFillApp() {
        ...
        anImgRndrr = new ImageRndrr(aCnnctCmpntFillFltr);
    ...
    public static void main(String args[]) {
        ...
        CnnctLabelFillApp anImgFrmApp = new CnnctLabelFillApp();
    ...
    public void startApp1() {
        ...
        try {
            ...
            Logger.getLogger(CnnctLabelFillApp.class.getName()).log(Level.SEVERE, null, ex);
