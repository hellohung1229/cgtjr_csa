 ...
 * @author Nit
 */
public class IntnstySpprssApp extends JApplet
{
   ...
   public static void main( String args[] ) 
   {
      ...
      IntnstySpprssApp anImgFrmApp = new IntnstySpprssApp();
