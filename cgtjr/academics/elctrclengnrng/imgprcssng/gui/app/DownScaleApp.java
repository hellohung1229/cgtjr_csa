...
import cgtjr.academics.elctrclengnrng.imgprcssng.DownSample;
 ...
 * @author Nit
 */
public class DownScaleApp extends JApplet {
    ...
    public DownScaleApp() {
        ...
        DownSample aDownSample = new DownSample();
        anImgRndrr = new ImageRndrr(aDownSample);
    ...
    public static void main(String args[]) {
        ...
        DownScaleApp anImgFrmApp = new DownScaleApp();
