...
import cgtjr.academics.elctrclengnrng.cv.DLTPlaneTrackFltr;
...
public class HTransTrackApp extends JApplet {
    ...
    public HTransTrackApp() {
        ...
        DLTPlaneTrackFltr aDLTPlaneTrack = new DLTPlaneTrackFltr();
        aDLTPlaneTrack.setP2x1(0);
        aDLTPlaneTrack.setP2y1(0);
        aDLTPlaneTrack.setP2x2(6.1);
        aDLTPlaneTrack.setP2y2(.76);
        aDLTPlaneTrack.setP2x3(6.1);
        aDLTPlaneTrack.setP2y3(42.67);
        aDLTPlaneTrack.setP2x4(8.53);
        aDLTPlaneTrack.setP2y4(42.67);

        aDLTPlaneTrack.setP1x1(52);
        aDLTPlaneTrack.setP1y1(231);
        aDLTPlaneTrack.setP1x2(316);
        aDLTPlaneTrack.setP1y2(200);
        aDLTPlaneTrack.setP1x3(92);
        aDLTPlaneTrack.setP1y3(58);
        aDLTPlaneTrack.setP1x4(142);
        aDLTPlaneTrack.setP1y4(58);
        
        anImgRndrr = new ImageRndrr(aDLTPlaneTrack);
    ...
    public static void main(String args[]) {
        ...
        HTransTrackApp anImgFrmApp = new HTransTrackApp();
