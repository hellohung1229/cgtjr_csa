...
import cgtjr.academics.elctrclengnrng.cv.HOGFeatureSqnceFilter;
...
public class HogFeatureSqnceApp extends JApplet
{
    ...
    public HogFeatureSqnceApp()
    {
      ...
      HOGFeatureSqnceFilter aHOGFeatureSqnceFilter = new HOGFeatureSqnceFilter();           
      anImgRndrr = new ImageRndrr(aHOGFeatureSqnceFilter); 
   ...
   public static void main( String args[] ) 
   {
      ...
      HogFeatureSqnceApp anImgFrmApp = new HogFeatureSqnceApp();
