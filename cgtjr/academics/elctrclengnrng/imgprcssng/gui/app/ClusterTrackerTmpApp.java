...
import cgtjr.academics.elctrclengnrng.cv.clustering.HOGClusterTrack;
 ...
 * @author Nit
 */
public class ClusterTrackerTmpApp extends JApplet {

    private ImgPlyrCnvs anImgPlyrCnvs;
    private ImageRndrr anImgRndrr;
    private ArrayList anImgArryLst;
    ImgFrmeParser imgFrmeParser;

    public ClusterTrackerTmpApp() {
        ...
        //Compute frame time ...
        HOGClusterTrack aCluster3DTrackFltr = new HOGClusterTrack();
        aCluster3DTrackFltr.getClusterHOGTrackerTmp().setMaxClusterDistance(70);        
        aCluster3DTrackFltr.getCornerDetectGrdntTmp().setEigenThreshold(40);
        aCluster3DTrackFltr.getTmprlGrdntFilter().setTmprlGrdntThrshld(35);
        imgFrmeParser = new ImgFrmeParser(aCluster3DTrackFltr);
        /*
        aCluster3DTrackFltr.setDisplayCorners(true);
        aCluster3DTrackFltr.setDisplayArrows(false);
        aCluster3DTrackFltr.setDisplayHOG(false);
        ...
        aCluster3DTrackFltr.setMaxClusterDistance(8);
        aCluster3DTrackFltr.setMaxMatchDstnce(50);
        */
        anImgRndrr = new ImageRndrr(imgFrmeParser);
        //anImgRndrr.setStartOffset(80);
        //anImgRndrr.setStopOffset(20);        
    ...
    public static void main(String args[]) {
        ...
        ClusterTrackerTmpApp anImgFrmApp = new ClusterTrackerTmpApp();
