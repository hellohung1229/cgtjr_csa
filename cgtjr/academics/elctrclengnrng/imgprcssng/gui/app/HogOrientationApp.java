...
public class HogOrientationApp extends JApplet {
    ...
    public HogOrientationApp() {
        ...
        HOGOrientationFilter aHOGOrientationFilter = new HOGOrientationFilter();
        anImgRndrr = new ImageRndrr(aHOGOrientationFilter);
    ...
    public static void main(String args[]) {
        ...
        HogOrientationApp anImgFrmApp = new HogOrientationApp();
