...
import cgtjr.academics.elctrclengnrng.imgprcssng.UpScaleWindow;
...
public class UpScaleWindowApp extends JApplet {
    ...
    public UpScaleWindowApp() {
        ...
        UpScaleWindow aUpScaleWindow = new UpScaleWindow();
        anImgRndrr = new ImageRndrr(aUpScaleWindow);
    ...
    public static void main(String args[]) {
        ...
        UpScaleWindowApp anImgFrmApp = new UpScaleWindowApp();
