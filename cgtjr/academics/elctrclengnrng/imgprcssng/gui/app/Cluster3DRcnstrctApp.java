...
import cgtjr.academics.elctrclengnrng.cv.clustering.Cluster3DRcnstrctFltr;
...
public class Cluster3DRcnstrctApp extends JApplet {
    ...
    public Cluster3DRcnstrctApp() {
        ...
        Cluster3DRcnstrctFltr aCluster3DRcnstrctFltr = new Cluster3DRcnstrctFltr();
        aCluster3DRcnstrctFltr.setThreshold(10000);
        aCluster3DRcnstrctFltr.setTmprlGrdntThrshld(15);        
        aCluster3DRcnstrctFltr.setClusterMaxDistance(40);
        aCluster3DRcnstrctFltr.setMatchDstnceThrshld(30);
        aCluster3DRcnstrctFltr.setHogDstnceThrshld(0.005);        
        aCluster3DRcnstrctFltr.setDisplayArrows(true);
        aCluster3DRcnstrctFltr.setDisplayBoundary(true);
        aCluster3DRcnstrctFltr.setDisplayCorners(true);
        anImgRndrr = new ImageRndrr(aCluster3DRcnstrctFltr);
    ...
    public static void main(String args[]) {
        ...
        Cluster3DRcnstrctApp anImgFrmApp = new Cluster3DRcnstrctApp();
