 ...
 * @author Nit
 */
public class GradientFeatureUpload extends JApplet {
    ...
    public static void main(String args[]) {
        ...
        GradientFeatureUpload anImgFrmApp = new GradientFeatureUpload();
    ...
    public void startApp1() {
        ...
        try {
            ...
            Logger.getLogger(GradientFeatureUpload.class.getName()).log(Level.SEVERE, null, ex);
        } catch (IOException ex) {
            Logger.getLogger(GradientFeatureUpload.class.getName()).log(Level.SEVERE, null, ex);
        }
        System.out.println("GradientFeatureUpload : path name = " + mediaURL);
        System.err.println("GradientFeatureUpload : path name = " + mediaURL);
    ...
    public void transmitData() {
        ...
        System.out.println("GradientFeatureUpload: transmitting data to "+urlPath);
        try {
