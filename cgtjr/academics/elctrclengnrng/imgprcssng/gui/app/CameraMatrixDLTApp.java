...
import cgtjr.academics.elctrclengnrng.cv.clustering.Cluster3DBoundFltr;
...
public class CameraMatrixDLTApp extends JApplet {
    ...
    public CameraMatrixDLTApp() {
        ...
        Cluster3DBoundFltr aCluster3DBoundFltr = new Cluster3DBoundFltr();
        anImgRndrr = new ImageRndrr(aCluster3DBoundFltr);
    ...
    public static void main(String args[]) {
        ...
        CameraMatrixDLTApp anImgFrmApp = new CameraMatrixDLTApp();
