...
import cgtjr.academics.elctrclengnrng.cv.clustering.ClusterLocationFltr;
...
public class ClusterLocationApp extends JApplet
{
    ...
    public ClusterLocationApp()
    {
      ...
      ClusterLocationFltr aClusterLocationFltr = new ClusterLocationFltr();          
      aClusterLocationFltr.setThreshold(100);
      aClusterLocationFltr.setClusterMaxDistance(20);      
      aClusterLocationFltr.setMatchDstnceThrshld(40);   
      aClusterLocationFltr.setDisplayArrows(false);
      aClusterLocationFltr.setDisplayBoundary(true);      
      aClusterLocationFltr.setDisplayDigit(true);    
      
      anImgRndrr = new ImageRndrr(aClusterLocationFltr); 
   ...
   public static void main( String args[] ) 
   {
      ...
      ClusterLocationApp anImgFrmApp = new ClusterLocationApp();
    ...
    public void retrieveMedia() {
        ...
        try {
            ...
            Logger.getLogger(ClusterLocationApp.class.getName()).log(Level.SEVERE, null, ex);
        } catch (IOException ex) {
            Logger.getLogger(ClusterLocationApp.class.getName()).log(Level.SEVERE, null, ex);
        }
