...
import cgtjr.academics.elctrclengnrng.imgprcssng.color.RGBtoHSIFltr;
 ...
 * @author Nit
 */
public class RGBtoHSIApp extends JApplet
{
    ...
    public RGBtoHSIApp()
    {
      ...
      anImgRndrr = new ImageRndrr(new RGBtoHSIFltr());
   ...
   public static void main( String args[] ) 
   {
      ...
      RGBtoHSIApp anImgFrmApp = new RGBtoHSIApp();
