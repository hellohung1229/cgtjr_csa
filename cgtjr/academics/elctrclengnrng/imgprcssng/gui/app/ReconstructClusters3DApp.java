 ...
 * @author Nit
 */
public class ReconstructClusters3DApp extends JApplet
{
    ...
    public ReconstructClusters3DApp()
    {
      ...
      aFndmntlMatrixDLTHOG.setEigenThreshold(500);
      aFndmntlMatrixDLTHOG.setTmprlGrdntThrshld(10);        
   ...
   public static void main( String args[] ) 
   {
      ...
      ReconstructClusters3DApp anImgFrmApp = new ReconstructClusters3DApp();
