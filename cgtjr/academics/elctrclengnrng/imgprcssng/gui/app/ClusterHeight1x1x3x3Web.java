...
public class ClusterHeight1x1x3x3Web extends JApplet {
    ...
    public ClusterHeight1x1x3x3Web() {
      ...
      aClusterHeightHOGFltr.setThreshold(50);
      aClusterHeightHOGFltr.setClusterMaxDistance(25);      
      aClusterHeightHOGFltr.setMatchDstnceThrshld(40);   
      aClusterHeightHOGFltr.setDisplayArrows(false);
      aClusterHeightHOGFltr.setDisplayDigit(false);      
    ...
    public static void main(String args[]) {
        ...
        ClusterHeight1x1x3x3Web anImgFrmApp = new ClusterHeight1x1x3x3Web();
    ...
    public void startApp1() {
        ...
        try {
            ...
            Logger.getLogger(ClusterHeight1x1x3x3Web.class.getName()).log(Level.SEVERE, null, ex);
