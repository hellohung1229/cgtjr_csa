...
import cgtjr.academics.elctrclengnrng.cv.DLTHOG;
...
public class EuclideanTransFrameWeb extends JApplet {
    ...
    public EuclideanTransFrameWeb() {
        ...
        DLTHOG aDLTHOG = new DLTHOG(); 
        anImgRndrr = new ImageRndrr(aDLTHOG);
    ...
    public static void main(String args[]) {
        ...
        EuclideanTransFrameWeb anImgFrmApp = new EuclideanTransFrameWeb();
    ...
    public void startApp1() {
        ...
        try {
            ...
            Logger.getLogger(EuclideanTransFrameWeb.class.getName()).log(Level.SEVERE, null, ex);
