 ...
 * @author Nit
 */
public class StereoImagesScroll extends JApplet
{
    ...
    public StereoImagesScroll()
    {
      
      aScrollPane = new ScrollPane();
   ...
   public static void main( String args[] ) 
   {
      ...
      StereoImagesScroll anImgFrmApp = new StereoImagesScroll();
