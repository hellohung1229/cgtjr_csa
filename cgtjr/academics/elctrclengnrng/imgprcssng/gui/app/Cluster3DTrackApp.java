 ...
 * @author Nit
 */
public class Cluster3DTrackApp extends JApplet
{
    ...
    public Cluster3DTrackApp()
    {
      ...
      Cluster3DTrackFltr aCluster3DTrackFltr = new Cluster3DTrackFltr();          
   ...
   public static void main( String args[] ) 
   {
      ...
      Cluster3DTrackApp anImgFrmApp = new Cluster3DTrackApp();
