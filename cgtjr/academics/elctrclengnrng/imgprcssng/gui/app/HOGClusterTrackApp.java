...
public class HOGClusterTrackApp extends JApplet {
    ...
    public HOGClusterTrackApp() {
        ...
        /*
        aClusterTrackFltr.setDisplayCorners(true);
        aClusterTrackFltr.setDisplayArrows(false);
        aClusterTrackFltr.setDisplayHOG(true);
        aClusterTrackFltr.setDisplayBoundary(true);
        aClusterTrackFltr.setEigenThreshold(10000);
        aClusterTrackFltr.setTmprlGrdntThrshld(25);
        aClusterTrackFltr.setMaxClusterDistance(5);
        */
        ...
        anImgRndrr = new ImageRndrr(aClusterTrackFltr);
    ...
    public static void main(String args[]) {
        ...
        HOGClusterTrackApp anImgFrmApp = new HOGClusterTrackApp();
