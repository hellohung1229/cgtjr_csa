...
import cgtjr.academics.elctrclengnrng.cv.clustering.KMeanClstrFltr;
 ...
 * @author Nit
 */
public class KMeanApp extends JApplet
{
    ...
    public KMeanApp()
    {
      ...
      anImgRndrr = new ImageRndrr(new KMeanClstrFltr());
   ...
   public static void main( String args[] ) 
   {
      ...
      KMeanApp anImgFrmApp = new KMeanApp();
