...
import cgtjr.academics.elctrclengnrng.cv.HOGFeatureCompareFilter;
...
public class HogFeatureOrientApp extends JApplet
{
    ...
    public HogFeatureOrientApp()
    {
      ...
      HOGFeatureCompareFilter aHOGFeatureOrientFilter = new HOGFeatureCompareFilter();           
      anImgRndrr = new ImageRndrr(aHOGFeatureOrientFilter); 
   ...
   public static void main( String args[] ) 
   {
      ...
      HogFeatureOrientApp anImgFrmApp = new HogFeatureOrientApp();
