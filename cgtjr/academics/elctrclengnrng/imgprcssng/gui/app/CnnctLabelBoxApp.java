...
import cgtjr.academics.elctrclengnrng.imgprcssng.complabel.CnnctCmpnntBoxLbl;
...
public class CnnctLabelBoxApp extends JApplet {
    ...
    public CnnctLabelBoxApp() {
        ...
        anImgRndrr = new ImageRndrr(aCnnctCmpnntBoxLbl);
    ...
    public static void main(String args[]) {
        ...
        CnnctLabelBoxApp anImgFrmApp = new CnnctLabelBoxApp();
    ...
    public void startApp1() {
        ...
        try {
            ...
            Logger.getLogger(CnnctLabelBoxApp.class.getName()).log(Level.SEVERE, null, ex);
