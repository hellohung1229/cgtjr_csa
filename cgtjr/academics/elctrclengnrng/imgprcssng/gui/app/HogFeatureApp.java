...
import cgtjr.academics.elctrclengnrng.cv.HOGFeatureFilter;
...
public class HogFeatureApp extends JApplet
{
    ...
    public HogFeatureApp()
    {
      ...
      HOGFeatureFilter aHOGFeatureFilter = new HOGFeatureFilter();           
      anImgRndrr = new ImageRndrr(aHOGFeatureFilter); 
   ...
   public static void main( String args[] ) 
   {
      ...
      HogFeatureApp anImgFrmApp = new HogFeatureApp();
