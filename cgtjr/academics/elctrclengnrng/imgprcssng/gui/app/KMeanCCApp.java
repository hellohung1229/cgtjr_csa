...
import cgtjr.academics.elctrclengnrng.imgprcssng.complabel.RcrsvCnncKMeantFltr;
 ...
 * @author Nit
 */
public class KMeanCCApp extends JApplet {
    ...
    public KMeanCCApp() {
        ...
        */
        ...
        RcrsvCnncKMeantFltr aRcrsvCnncKMeantFltr = new RcrsvCnncKMeantFltr();
        //aRcrsvCnncKMeantFltr.setInputFilter(aNghbrThreshold1);              
        anImgRndrr9 = new ImageRndrr(aRcrsvCnncKMeantFltr);          
    ...
    public static void main(String args[]) {
        ...
        KMeanCCApp anImgFrmApp = new KMeanCCApp();
