...
import cgtjr.academics.math.quadrature.Integration;
...
public class HxhdrlBss extends BssFnctn implements Integration
{
   private double x0;
   private double x1;
   private double x2;
   ...
   private GssLgndr aBssGssLgndr;

   public HxhdrlBss()
   {
      aBssGssLgndr = new GssLgndr(this);
   }
   ...
   public double cmptCffcntMtrx(int m,int n)
   {
      ...
      double rslt = aBssGssLgndr.intgrt3D();
      return rslt;
   }
   ...
   {
      setBssNds(myX[0],myX[6],myY[0],myY[6],myZ[6],myZ[0]);
   }
   public void setBssNds(double myX0,double myX1,double myY0,double myY1,double myZ0,double myZ1)
   {
      x0 = myX0;
      x1 = myX1;
      y0 = myY0;
      ...
      z0 = myZ0;
      z1 = myZ1;
      //System.out.println("Hxhdrl.setBssNds() y100 = "+y100+",y101="+y101);
      //System.out.println("HxhdrlBss.setBssNds() x0="+x0+",x1="+x1+",y0="+y0+",y1="+y1+",z0="+z0+",z1="+z1);
   }
   ...
   public double cmptIntgrl(double myX)
   {
      return 0;
   }
   public double cmptIntgrl(double myX,double myY)
   {
      return 0;
   }
   public double cmptIntgrl(double myX,double myY,double myZ)
   {
      return cmptBssDrvtv(index1,index2,myX,myY,myZ);
   }
}