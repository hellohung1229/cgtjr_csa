 ...
 */
public class FEMClndrclBttn extends ClndrclBttn
{
   public FEMClndrclBttn(SceneRoot mySceneRoot)
   {
      super(mySceneRoot);
   }
   public FEMClndrclBttn(SceneRoot mySceneRoot,Applet myLabWndwPnl)
   {
