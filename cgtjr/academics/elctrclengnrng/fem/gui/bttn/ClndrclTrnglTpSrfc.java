 ...
 */
public class ClndrclTrnglTpSrfc extends ClndrclBttn
{

   public ClndrclTrnglTpSrfc(SceneRoot mySceneRoot)
   {
      super(mySceneRoot);
   }
   public ClndrclTrnglTpSrfc(SceneRoot mySceneRoot,Applet myLabWndwPnl)
   {
