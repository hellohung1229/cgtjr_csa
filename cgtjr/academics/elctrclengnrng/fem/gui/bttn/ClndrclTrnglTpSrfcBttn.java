 ...
 */
public class ClndrclTrnglTpSrfcBttn extends ClndrclBttn
{

   public ClndrclTrnglTpSrfcBttn(SceneRoot mySceneRoot)
   {
      super(mySceneRoot);
   }
   public ClndrclTrnglTpSrfcBttn(SceneRoot mySceneRoot,Applet myLabWndwPnl)
   {
