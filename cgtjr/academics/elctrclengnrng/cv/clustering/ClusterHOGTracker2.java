...
import static cgtjr.academics.elctrclengnrng.imgprcssng.general.ImageFilter.isInBound;
...
public class ClusterHOGTracker2 extends HOGCornerDetector {
    ...
    public void clusterHOG(int dataValues[], int i) {
        ...
        //    return;
        //}
        if (isInBound(i, getImageWidth(), getImageHeight(), 1, 1,getImageWidth()-1, getImageHeight()-50)) {
