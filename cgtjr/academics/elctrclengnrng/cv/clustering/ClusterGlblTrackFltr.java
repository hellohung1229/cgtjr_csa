...
public class ClusterGlblTrackFltr extends HOGCornerDetectOptmzd {
    ...
    public void insertHOG(HOGPosition myHOGPosition) {
        ...
        if (aSet.isEmpty()) {
            aRectBndryHOGArrayList = new RectBndryGlblHOGTree(myHOGPosition);
    ...
    public void drawHOG(RectBndryGlblHOGTree aRectBndryGlblHOGTree) {
        ...
        if(aHOG == null || aHOG[0][0] == null) return;        
