...
public class ClusterHOGTrackerTmp// extends HOGCornerDetector 
{
    ...
    private int colorList[] = {0x774F38, 0xF1D4AF, 0x1A2611, 0x000000ff, 0x00ff0000, 0x0000ff00, 0x00ff00ff, 0x00ffff00, 0x0000ffff, 0x00ff4000, 0x0000ff40, 0x004000ff};
    ...
    public void displayData() {
        ...
        //System.out.println("ClusterHOGTracker : display data ...");
    ...
    public void drawHOG(RectBndryGlblHOGTree aRectBndryGlblHOGTree) {
        ...
        //System.out.println("ClusterGlblTrackTmp : bin size = "+binSize);
    ...
    public void drawCentroidHOG(RectBndryGlblHOGTree aRectBndryGlblHOGTree) {
        ...
        //System.out.println("ClusterGlblTrackerTmp : bin size = "+binSize);
        for (int i = 0; i < binSize; i++) {
            double angle = aCentroidHG.getAngleByIndex(i);
    ...
    public void drawHOG2(RectBndryGlblHOGTree aRectBndryGlblHOGTree) {
