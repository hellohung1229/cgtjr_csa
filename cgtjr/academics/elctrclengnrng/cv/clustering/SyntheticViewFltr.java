...
public class SyntheticViewFltr extends HOGCornerDetectOptmzd {
    ...
    private VanishingHeightWidth objectHeight;    
    private DigitPxls theDigitPxls;
    private KConstraints constraints;
    ...
    public void initialize(int myImageWidth, int myImageHeight) {
        ...
        if(objectHeight == null){
           objectHeight = new VanishingHeightWidth();
           objectHeight.computeVP();
        }
        if(constraints == null){
           constraints = new KConstraints();
           constraints.computeKMatrix(objectHeight);
        }        
        if(theDigitPxls == null){
           theDigitPxls = new DigitPxls();
        }
    ...
    public void printData() {
        ...
        while (anIterator1.hasNext()) {
            ...
            //System.out.println("----------frame number : "+getFrameIndex()+"------------");
            aRectBndryHOGArrayList = (RectBndryHOGTree) aTreeMap.get(aGroupKey);
            objectHeight.computeWidthHeight(aRectBndryHOGArrayList);    
            //objectHeight.computeWidthHeight();
            ...
            if(getDisplayDigit()){
               DigitPxls.drawDigit(myPixelData, anImageWidth, anImageHeight, x, y, (int)objectHeight.getObjectHeight());                           
            }            
        }
    }
