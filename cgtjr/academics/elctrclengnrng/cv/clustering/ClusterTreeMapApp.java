 ...
 * @author Nit
 */
public class ClusterTreeMapApp extends JApplet
{
    ...
    public ClusterTreeMapApp()
    {
      anImgArryLst = new ArrayList();      
      anImgPlyrCnvs = new ImgPlyrCnvs(anImgArryLst);
      anImgRndrr = new ImageRndrr(new ClusterTreeMapFltr());
   ...
   public static void main( String args[] ) 
   {
      ...
      ClusterTreeMapApp anImgFrmApp = new ClusterTreeMapApp();
