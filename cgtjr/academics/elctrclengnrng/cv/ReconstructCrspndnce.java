 ...
 */
public class ReconstructCrspndnce {
    ...
    public ReconstructCrspndnce(int myImageWidth, int myImageHeight) {
    ...
    public double[] computeFndmntlMatrix(){
      //Matrix.print(matrixA8x8);
      //double aFndmntl[] = computeFundamental(matrixANx9);
      ManualCrrspndnce aCorrespondence = new ManualCrrspndnce(getImageWidth(),getImageHeight());
      matrixANx9 = aCorrespondence.crteCrrspndnceMatrix();
      //double aFndmntl[] = computeFundamental2(matrixA8x8, oneVec);
      double aFndmntl[] = computeFundamental(matrixANx9);
      Matrix.print(aFndmntl);
      //double aFndmntl3x3[][] = Matrix.convert9x1To3x3Add1(aFndmntl);    
    ...
    public void computeEpipoles(){
        double aFndmtl1x9[] = computeFndmntlMatrix();
