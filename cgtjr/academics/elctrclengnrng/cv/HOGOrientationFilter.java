 ...
 * @author finitesystem
 */
public class HOGOrientationFilter extends CornerDetect {
    ...
    public void filter(int grayValues[], int i) {
        ...
        //}
        //if (featureSearch) {
        super.cornerDetect3x3In9x9(grayValues, i);
        //}
        if (getEigenValue(i) >= getThreshold()) {
            descriptorsHOG1x1(grayValues, i);
            //featureSearch = false;
        }
    }
    ...
    public void descriptorsHOG1x1(int myGrayValues[], int anIndex) {
        ...
        //System.out.println(hogradients[0][0].getMaxGradientAngle());
