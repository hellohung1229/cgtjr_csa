...
import cgtjr.academics.elctrclengnrng.imgprcssng.GrdntFilterParser;
import cgtjr.academics.elctrclengnrng.imgprcssng.draw.ImageDrawData;
import cgtjr.academics.general.ImageTool;
import cgtjr.academics.math.lnralgbra.Matrix;

public class CornerDetectGrdnt extends GrdntFilterParser {
    ...
    public void initialize(int myImageWidth, int myImageHeight) {
        ...
        //System.out.println("CornerDetectGrdnt test 1: initial ...");
        //System.out.println("CornerDetectGrdnt test 2: initial ...");
    }
    ...
    public void cornerDetect(int pixelValues[], int i) {
        if (getTemporalGradientValues(i) > getTmprlGrdntThrshld()) {
        cornerDataPixel[i] = pixelValues[i];

        super.gradientGryFilter(pixelValues, i);
    ...
    public void updtCornerPixels(int cornerDataPixel[], int i,int aColor) {
        ...
        if (isInBounds3x3(i)) {
            ...
            /*
             ...
             cornerDataPixel[i + imageWidth + 1] = 0x00ff0000;
            */
            getImageDrawData().drawData(0x0000aaff, i - imageWidth - 1);
            getImageDrawData().drawData(0x0000aaff, i - imageWidth);
            getImageDrawData().drawData(0x0000aaff, i - imageWidth + 1);
            getImageDrawData().drawData(0x0000aaff, i - 1);
            //getImageDrawData().drawData(0x0000aa00, i);
            getImageDrawData().drawData(0x0000aaff, i + 1);
            getImageDrawData().drawData(0x0000aaff, i + imageWidth - 1);
            getImageDrawData().drawData(0x0000aaff, i + imageWidth);
            getImageDrawData().drawData(0x0000aaff, i + imageWidth + 1);
