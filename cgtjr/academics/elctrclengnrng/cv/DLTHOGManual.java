 ...
 */
public class DLTHOGManual extends HOGCornerDetectOptmzd {
    ...
    */
    ...
    private int p1x1 = 193;
    private int p1y1 = 128;
    private int p1x2 = 193;
    private int p1y2 = 169;
    private int p1x3 = 218;
    private int p1y3 = 169;
    private int p1x4 = 218;
    private int p1y4 = 128;
    
    private int p2x1 = 192;
    private int p2y1 = 141;
    private int p2x2 = 193;
    private int p2y2 = 169;
    private int p2x3 = 218;
    private int p2y3 = 169;
    private int p2x4 = 213;
    private int p2y4 = 141;
    
    public void initialize(int myImageWidth, int myImageHeight) {
        super.initialize(myImageWidth, myImageHeight); //To change body of generated methods, choose Tools | Templates.
        System.out.println("DLTHOGManual : frame number = "+getFrameIndex());
    ...
    public void computeView(int dataValues[],int i){
        ...
        //System.out.println("DLTHOGManual : index = "+anIndex +", color = "+dataValues[i]);
           System.out.println("DLTHOGManual : x1 = "+aX1[0] +", y1 = "+aX1[1]+", x2 = "+aX2[0]+", y2 = "+aX2[1]);        
    ...
    public int[] getFltrdData() {
        System.out.println("DLTHOGManual.getFltrData()");
    ...
    public void setP1x1(int myP1x1) {
        this.p1x1 = myP1x1;
    }
    ...
    public void setP1y1(int myP1y1) {
        this.p1y1 = myP1y1;
    }
    ...
    public void setP1x2(int myP1x2) {
        this.p1x2 = myP1x2;
    }
    ...
    public void setP1y2(int myP1y2) {
        this.p1y2 = myP1y2;
    }
    ...
    public void setP1x3(int myP1x3) {
        this.p1x3 = myP1x3;
    }
    ...
    public void setP1y3(int myP1y3) {
        this.p1y3 = myP1y3;
    }
    ...
    public void setP1x4(int myP1x4) {
        this.p1x4 = myP1x4;
    }
    ...
    public void setP1y4(int myP1y4) {
        this.p1y4 = myP1y4;
    }
    ...
    public void setP2x1(int myP2x1) {
        this.p2x1 = myP2x1;
    }
    ...
    public void setP2y1(int myP2y1) {
        this.p2y1 = myP2y1;
    }
    ...
    public void setP2x2(int myP2x2) {
        this.p2x2 = myP2x2;
    }
    ...
    public void setP2y2(int myP2y2) {
        this.p2y2 = myP2y2;
    }
    ...
    public void setP2x3(int myP2x3) {
        this.p2x3 = myP2x3;
    }
    ...
    public void setP2y3(int myP2y3) {
        this.p2y3 = myP2y3;
    }
    ...
    public void setP2x4(int myP2x4) {
        this.p2x4 = myP2x4;
    }
    ...
    public void setP2y4(int myP2y4) {
        this.p2y4 = myP2y4;
    }   
}