 ...
 * @author finitesystem
 */
public class HOGFeatureSqnceFilter extends CornerDetect {
    ...
    public double compute(HistogramOG myHOG1, HistogramOG myHOG2, int myIndex1, int myIndex2) {
    ...
    public double compute(HistogramOG myHOG1[][], HistogramOG myHOG2[][]) {
        double hogDiff00 = compute(myHOG1[0][0], myHOG2[0][0]);
        double hogDiff01 = compute(myHOG1[0][1], myHOG2[0][1]);
        double hogDiff02 = compute(myHOG1[0][2], myHOG2[0][2]);
        double hogDiff10 = compute(myHOG1[1][0], myHOG2[1][0]);
        double hogDiff11 = compute(myHOG1[1][1], myHOG2[1][1]);
        double hogDiff12 = compute(myHOG1[1][2], myHOG2[1][2]);
        double hogDiff20 = compute(myHOG1[2][0], myHOG2[2][0]);
        double hogDiff21 = compute(myHOG1[2][1], myHOG2[2][1]);
        double hogDiff22 = compute(myHOG1[2][2], myHOG2[2][2]);
