...
public class MshShpScene extends BranchGroup
{
   ...
   public MshShpScene(ShapePnt myShape)
   {
      shp = myShape;
   ...
   public MshShpScene(MeshShp myMeshShp)
   {
      setCapability(BranchGroup.ALLOW_CHILDREN_READ);
      setCapability(BranchGroup.ALLOW_CHILDREN_WRITE);
      setCapability(BranchGroup.ALLOW_CHILDREN_EXTEND);
      initialize(myMeshShp);
      crtScene();
   }
   private void initialize(MeshShp myMeshShp)
   {
