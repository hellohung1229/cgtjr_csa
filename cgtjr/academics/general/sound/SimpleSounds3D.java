 ...
 * @version 1.0
 */
public class SimpleSounds3D extends Frame implements ActionListener {
  ...
  protected void addBackgroundSound(BranchGroup b, String soundFile) {
    ...
    String file = "file:C:\\cthomas\\developement\\us3da_crrnt\\src\\public_html\\us3da\\cgtjr\\academics\\general\\sound\\ambiencescifi2.wav";      
    MediaContainer droneContainer = null;      
    try{
    URL aURL = new URL(file);
        //soundContainer.setURLObject(aURL);
        droneContainer = new MediaContainer(aURL);
    }catch(Exception e){
  ...
  protected void addObjectSound(TransformGroup tg, PointSound sound,
    ...
    String file = "file:C:\\cthomas\\developement\\us3da_crrnt\\src\\public_html\\us3da\\cgtjr\\academics\\general\\sound\\scifiexplosions2.wav";
    System.out.println("file = "+soundFile);
    //MediaContainer soundContainer = new MediaContainer(soundFile);
    MediaContainer soundContainer = null;
    try{
    URL aURL = new URL(file);
        //soundContainer.setURLObject(aURL);
        soundContainer = new MediaContainer(aURL);
    }catch(Exception e){
        
    }
    //soundContainer.setURLString(file);
  ...
  protected BranchGroup buildContentBranch() {
    ...
    addObjectSound(cubeGroup, sound1,"file:C:cthomas\\developement\\us3da_crrnt\\src\\public_html\\us3da\\data\\sound\\ambiencescifi2.wav", 10.0f);
    addObjectSound(cubeGroup, sound2,"file:C:cthomas\\developement\\us3da_crrnt\\src\\public_html\\us3da\\data\\sound\\scifiexplosions2.wav", 20.0f);
    addBackgroundSound(contentBranch,"file:C:cthomas\\developement\\us3da_crrnt\\src\\public_html\\us3da\\data\\sound\\scifiexplosions2.wav");
  ...
  public static void main(String[] args) {
    SimpleSounds3D sw = new SimpleSounds3D();
  }
}
