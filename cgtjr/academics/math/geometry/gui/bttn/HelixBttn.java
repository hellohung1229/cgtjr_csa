 ...
 */
public class HelixBttn extends JButton
{
    ...
    */
   public HelixBttn(SceneRoot mySceneRoot)
   {
      super();
      scnRt = mySceneRoot;
      //Toolkit tk = Toolkit.getDefaultToolkit();
      
      String aFileInfo = "/data/images/shapes/hlx1_3D.gif";
    ...
    */
   public HelixBttn(SceneRoot mySceneRoot,Applet myLabWndwPnl)
   {
      super();
      scnRt = mySceneRoot;
      Image aFileInfo = ImageTool.rdImageFile("./data/images/shapes/hlx1_3D.gif",myLabWndwPnl);
      anIcon = new ImageIcon(aFileInfo);
      constructor();
      addActnLstnr();
   }
